...
<?php if(!empty($payoutAllocations[$p['id']])):?><div class="worklist"><?php foreach($payoutAllocations[$p['id']] as $a):?><div class="work-row"><div><b>Auftrag #<?=App\Core\View::e($a['order_number'])?></b><span>dieser Auszahlung zugeordnet</span></div><strong><?=number_format((float)$a['amount'],2,',','.')?> €</strong></div><?php endforeach;?></div><?php endif;?>
